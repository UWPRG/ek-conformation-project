...
from conf_entropy import conformational_entropy
...
for seq_idx in range(1):
    for temp_idx, temp in enumerate(temps):
        ...
        residue_wise_entropy = conformational_entropy(
            traj,
            bins=45,
            weights=frame_weights['norm_wt'].values,
            density=True,
        )
        average_conf_entropy = residue_wise_entropy.mean()
        print()
